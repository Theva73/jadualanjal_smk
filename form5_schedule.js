...
const form5Schedules = [
    ...
    },
    {
        ...
        rehatSlot: "10:15-10:30",
        scheduleData: {
            "ISNIN": [ { period: "8:15-9:15", subject: "PJ", teacher: "EN AHMAD" }, { period: "9:15-10:15", subject: "SN", teacher: "PN NOROSNIZA", location: "MAK. BIO" }, { period: "10:30-11:30", subject: "PS", teacher: "PN NIK" }, { period: "11:30-12:00", subject: "SJ", teacher: "PN. ROSIEATI" }, { period: "12:00-1:00", subject: "TAW", teacher: "PN RUHAZANA" }, { period: "1:00-2:00", subject: "PS", teacher: "EN. IQBAL" }, { period: "2:00-3:00", subject: "TAW", teacher: "UST HAJAR" } ],
    ...
    },
    {
        ...
        rehatSlot: "10:15-10:30",
        scheduleData: {
            "ISNIN": [ { period: "7:15-8:15", subject: "PJ", teacher: "EN AHMAD" }, { period: "9:15-10:15", subject: "SJ", teacher: "PN. KARTINI" }, { period: "10:30-11:30", subject: "M. KOM 2 BI", teacher: "PN. MASRUL" }, { period: "11:30-12:00", subject: "PS", teacher: "PN NIK" }, { period: "12:00-1:00", subject: "TAWN RUHAZANA" }, { period: "1:00-2:00", subject: "PS", teacher: "EN. IQBAL" }, { period: "2:00-3:00", subject: "TAW", teacher: "UST HAJAR" } ],
    ...
    },
    {
        ...
        scheduleData: {
            ...
            "RABU": [ { period: "7:15-8:15", subject: "KOKO" }, { period: "8:15-9:15", subject: "SN", teacher: "PN ARFAH", location: "MAK. FIZ" }, { period: "10:30-11:30", subject: "MM", teacher: "PN. RAIHAH" }, { period: "11:30-12:00", subject: "MM", teacher: "PN SYAMIMI" }, { period: "1:00-2:00", subject: "BM", teacher: "CIK NAZA" } ],
